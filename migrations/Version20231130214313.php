 ...
 */
final class Version20231130214313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, login LONGTEXT NOT NULL, pass LONGTEXT NOT NULL, email LONGTEXT NOT NULL, nom_complet LONGTEXT NOT NULL, statut VARCHAR(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
